...
@Composable
fun SalaryScreen(navController: NavHostController, database: AppDatabase) {
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(paddingValues).padding(16.dp)) {
            ...
            Spacer(modifier = Modifier.height(16.dp))
            Text("Monthly Salary: ${"%.2f".format(monthlySalary)}", style = MaterialTheme.typography.headlineMedium)
        }
    }
}
